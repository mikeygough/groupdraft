groupdraft is a lightweight collaborative writing tool built with the power of SocketIO. this app leverages web sockets (via SocketIO) to enable real-time collaboration on an html textarea element.
